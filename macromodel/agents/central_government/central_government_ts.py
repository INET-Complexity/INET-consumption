...
def create_central_government_timeseries(
    ...
    return TimeSeries(
        ...
        taxes_income=[data["Income Taxes"].values[0] - data["Rental Income Taxes"].values[0]],
        taxes_rental_income=[0.0],
        diagnostic_taxes_rental_income=[data["Rental Income Taxes"].values[0]],
        ...
        diagnostic_total_rent_received=[data["Total Social Housing Rent"].values[0]],
        #
        revenue=[
            data["Revenue"].values[0]
            - data["Rental Income Taxes"].values[0]
            - data["Total Social Housing Rent"].values[0]
        ],
