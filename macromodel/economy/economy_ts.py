...
def create_economy_timeseries(
    ...
    initial_cpi_weights: np.ndarray,
    initial_sectoral_household_consumption: np.ndarray,
    ...
    Args:
        ...
        initial_cpi_weights (np.ndarray): Initial household-consumption weights by sector
        initial_sectoral_household_consumption (np.ndarray): Household consumption by sector
    ...
    ts = TimeSeries(
        ...
        cpi_fixed_basket=[1.0],
        cpi_fixed_basket_pop_change=[initial_cpi_inflation],
        cpi_fixed_basket_yoy_change=[initial_cpi_inflation],
        cpi_chained_basket=[1.0],
        cpi_chained_basket_pop_change=[initial_cpi_inflation],
        cpi_chained_basket_yoy_change=[initial_cpi_inflation],
        cpi_fixed_basket_weights=initial_cpi_weights,
        cpi_chained_basket_weights=initial_cpi_weights,
        cpi_fixed_basket_base_prices=initial_sectoral_firm_prices,
        cpi_chained_basket_base_prices=initial_sectoral_firm_prices,
        cpi_chained_basket_link_level=[1.0],
        sectoral_household_consumption=initial_sectoral_household_consumption,
        #
        cpi_transaction_pop_change=[initial_cpi_inflation],
        cpi_transaction_yoy_change=[initial_cpi_yoy_inflation],
        ...
        subsistence_consumption_shortfall=np.zeros_like(initial_real_rent_paid, dtype=float),
        #
