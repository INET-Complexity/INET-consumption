"""Named scenario and plotting configuration for run-model notebooks."""
...
CALIBRATED_CONSUMPTION_OVERRIDES: dict[str, Any] = {
    "households.functions.consumption.parameters.['long_run_intercept']": -0.6,
...
MACRO_COLUMNS = (
    "total_consumption_to_gdp", "investment_to_gdp", "net_exports_to_gdp", "debt_to_gdp",
    "fiscal_revenue_to_gdp", "fiscal_expenditure_to_gdp", "deficit_to_gdp",
    "household_consumption_to_gdp", "government_consumption_to_gdp", "gdp", "inventory",
    "gdp_growth", "unemployment_rate", "central_bank_policy_rate", "wages", "profits",
    "cpi_transaction", "ppi", "cpi_transaction_yoy_change", "bank_insolvency_rate",
    "avg_tfp_multiplier",
)
FISCAL_COLUMNS = (
    ...
    "fiscal_expenditure", "deficit_to_gdp", "gdp_growth", "taxes_paid_on_production",
    "taxes_on_products", "real_demand",
)
POLICY_COLUMNS = (
    "unemployment_rate", "cpi_fixed_basket_yoy_change", "ppi_yoy_change", "central_bank_policy_rate",
    "short_term_firm_borrowing_rate", "long_term_firm_borrowing_rate",
    "household_consumption_borrowing_rate", "mortgage_borrowing_rate", "short_term_loans_to_firms",
    "long_term_loans_to_firms", "consumption_loans_to_households", "mortgages_to_households",
)
LABOUR_COLUMNS = (
    "wages", "economy_wage_rate", "participation_rate", "labour_input_shortfall_rate",
    "unfilled_jobs", "unemployment_rate", "vacancy_rate", "job_reallocation_rate",
    "job_reallocation_rate_growth",
)
BALANCE_SHEET_COLUMNS = (
    "household_assets", "household_liabilities", "household_net_worth",
    "household_balance_sheet_identity_residual", "firm_assets", "firm_liabilities", "firm_equity",
    "firm_balance_sheet_identity_residual", "bank_assets_proxy", "bank_liabilities", "bank_equity",
