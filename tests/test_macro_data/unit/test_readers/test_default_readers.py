...
def test__default_paths_resolves_calibration_paths():
    ...
    assert paths.permanent_income_forecast_table_path == (raw_data_path / "permanent_income" / "FR_table.json")
    assert paths.permanent_income_forecast_covariance_path == (raw_data_path / "permanent_income" / "FR_cov_hac.json")
